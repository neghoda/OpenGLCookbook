...
void SceneCloth::compileAndLinkShader() {
    try {
        renderProg.compileShader("Shaders/ads.vert");
        renderProg.compileShader("Shaders/ads.frag");
        renderProg.link();

        computeProg.compileShader("Shaders/cloth.cs");
        computeProg.link();

        computeProgNorm.compileShader("Shaders/cloth_normal.cs");
