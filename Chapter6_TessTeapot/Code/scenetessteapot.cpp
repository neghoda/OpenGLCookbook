...
void SceneTessTeapot::compileAndLinkShader() {
    try {
        prog.compileShader("Shaders/tessteapot.vert", GLSLShader::VERTEX);
        prog.compileShader("Shaders/tessteapot.frag", GLSLShader::FRAGMENT);
        prog.compileShader("Shaders/tessteapot.geom", GLSLShader::GEOMETRY);
        prog.compileShader("Shaders/tessteapot.tes",  GLSLShader::TESS_EVALUATION);
        prog.compileShader("Shaders/tessteapot.tcs",  GLSLShader::TESS_CONTROL);
        prog.link();
        prog.use();
    }
