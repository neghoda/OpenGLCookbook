...
void SceneTessTeapotDepth::compileAndLinkShader() {
    try {
        prog.compileShader("Shaders/tessteapotdepth.vert", GLSLShader::VERTEX);
        prog.compileShader("Shaders/tessteapotdepth.frag", GLSLShader::FRAGMENT);
        prog.compileShader("Shaders/tessteapotdepth.geom", GLSLShader::GEOMETRY);
        prog.compileShader("Shaders/tessteapotdepth.tes",  GLSLShader::TESS_EVALUATION);
        prog.compileShader("Shaders/tessteapotdepth.tcs",  GLSLShader::TESS_CONTROL);
        prog.link();
        prog.use();
    }
