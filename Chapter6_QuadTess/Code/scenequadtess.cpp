...
void SceneQuadTess::compileAndLinkShader() {
    try {
        prog.compileShader("Shaders/quadtess.vert");
        prog.compileShader("Shaders/quadtess.frag");
        prog.compileShader("Shaders/quadtess.geom");
        prog.compileShader("Shaders/quadtess.tes");
        prog.compileShader("Shaders/quadtess.tcs");
        prog.link();
        prog.use();
    }
