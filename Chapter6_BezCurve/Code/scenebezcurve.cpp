...
void SceneBezCurve::compileAndLinkShader() {
    try {
        prog.compileShader("Shaders/bezcurve.vert");
        prog.compileShader("Shaders/bezcurve.frag");
        prog.compileShader("Shaders/bezcurve.tes");
        prog.compileShader("Shaders/bezcurve.tcs");
        prog.link();
        prog.use();

        solidProg.compileShader("shaders/solid.vert");
        solidProg.compileShader("shaders/solid.frag");
        solidProg.link();
    }
