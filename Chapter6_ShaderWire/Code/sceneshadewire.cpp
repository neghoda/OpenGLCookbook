...
void SceneShadeWire::compileAndLinkShader() {
    try {
        prog.compileShader("Shaders/shadewire.vert", GLSLShader::VERTEX);
        prog.compileShader("Shaders/shadewire.frag", GLSLShader::FRAGMENT);
        prog.compileShader("Shaders/shadewire.geom", GLSLShader::GEOMETRY);
        prog.link();
        prog.use();
    }
